...
public class SearchSteps {
    ...
    public void clickFirstLink() {
    	Set<String> oldWindowsSet = searchPage.getWindowHandles();
    	
    	searchPage.clickFLink();
    	Set<String> newWindowsSet = searchPage.getWindowHandles();
    	newWindowsSet.removeAll(oldWindowsSet);
    	String newWindow = newWindowsSet.iterator().next();
    	searchPage.switchTo().window(newWindow);
    ...
    public void linkIsShown() {
        assertTrue(searchPage.verifyFirstLink());
    }
}
