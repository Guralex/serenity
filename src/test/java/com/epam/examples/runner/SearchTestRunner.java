...
public class SearchTestRunner extends JUnitStories {
    ...
    private WebDriverSteps lifecycleSteps = new PerStoriesWebDriverSteps(
        driverProvider); 									//ѕри каждой стори инициализаци€ и открытие
    private PageFactory pageFactory = new PageFactory(driverProvider); //инициализаци€ страниц дл€ драйвера один раз
